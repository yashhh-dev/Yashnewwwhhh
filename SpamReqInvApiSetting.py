...
GetLoginDataRegionMena = "https://client.ind.freefiremobile.com/GetLoginData" #CHANGE ACCORDING YOUR SERVER
MajorLoginRegionMena = "https://loginbp.ggblueshark.com/MajorLogin" #CHANGE ACCORDING YOUR SERVER 
accounts = {
